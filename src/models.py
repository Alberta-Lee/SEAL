...
class serverGraphSage_dc(torch.nn.Module):
    def __init__(self, n_se, nlayer, nhid):
        super(serverGraphSage_dc, self).__init__()

        self.embedding_s = torch.nn.Linear(n_se, nhid)
        self.Whp = torch.nn.Linear(nhid + nhid, nhid)

        self.graph_convs = torch.nn.ModuleList()
        self.graph_convs.append(SAGEConv(nhid + nhid, nhid))
        self.graph_convs_s_gcn = torch.nn.ModuleList()
        self.graph_convs_s_gcn.append(GCNConv(nhid, nhid))
...
class GraphSage_dc(torch.nn.Module):
    def __init__(self, nfeat, n_se, nhid, nclass, nlayer, dropout):
        super(GraphSage_dc, self).__init__()
        self.num_layers = nlayer
        self.dropout = dropout
...
class serverGAT_dc(torch.nn.Module):
    def __init__(self, n_se, nlayer, nhid):
        super(serverGAT_dc, self).__init__()

        self.embedding_s = torch.nn.Linear(n_se, nhid)
        self.Whp = torch.nn.Linear(nhid + nhid, nhid)

        self.graph_convs = torch.nn.ModuleList()
        self.graph_convs.append(GATConv(nhid + nhid, nhid))
        self.graph_convs_s_gcn = torch.nn.ModuleList()
        self.graph_convs_s_gcn.append(GCNConv(nhid, nhid))
...
class GAT_dc(torch.nn.Module):
    def __init__(self, nfeat, n_se, nhid, nclass, nlayer, dropout):
        super(GAT_dc, self).__init__()
        self.num_layers = nlayer
        self.dropout = dropout
